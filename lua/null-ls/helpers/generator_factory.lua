...
return function(opts)
    ...
    local function get_command(bufnr, done)
    ...
    return {
        setup_buffer = function(bufnr, done)
            -- Here we invoke `get_command` and throw away the result. Why? If
        ...
        fn = function(params, done)
            ...
            get_command(bufnr, function(resolved_command)
